...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(539, 290)
        self.frame = QtGui.QFrame(Dialog)
        self.frame.setGeometry(QtCore.QRect(20, 10, 421, 171))
        ...
        self.toolButton.setGeometry(QtCore.QRect(110, 10, 41, 21))
        self.toolButton.setObjectName(_fromUtf8("toolButton"))
        self.radioButton = QtGui.QRadioButton(self.frame)
        self.radioButton.setGeometry(QtCore.QRect(180, 20, 89, 16))
        ...
        self.commandLinkButton.setGeometry(QtCore.QRect(20, 50, 185, 41))
        self.commandLinkButton.setObjectName(_fromUtf8("commandLinkButton"))
        self.buttonBox = QtGui.QDialogButtonBox(self.frame)
        self.buttonBox.setGeometry(QtCore.QRect(250, 60, 156, 23))
